...
func TestCreateAlertRule(t *testing.T) {
	...
	initServiceWithData := func(t *testing.T) (*AlertRuleService, *fakes.RuleStore, *fakeProvisioningStore, *fakeRuleAccessControlService) {
...
func TestGetAlertRule(t *testing.T) {
	...
	t.Run("when user cannot read all rules", func(t *testing.T) {
		t.Run("should request entire group and return error if AuthorizeAccessToRuleGroup returns error", func(t *testing.T) {
			...
			_, _, err := service.GetAlertRule(context.Background(), u, rule.OrgID, rule.UID)
			require.Error(t, err)
		...
		t.Run("should request entire group and return single rule if AuthorizeAccessToRuleGroup passes", func(t *testing.T) {
			...
			actual, provenance, err := service.GetAlertRule(context.Background(), u, rule.OrgID, rule.UID)
			require.NoError(t, err)
		...
		t.Run("should return ErrAlertRuleNotFound if rule does not exist", func(t *testing.T) {
			...
			_, _, err := service.GetAlertRule(context.Background(), u, rule.OrgID, "no-rule-uid")
...
func TestGetRuleGroup(t *testing.T) {
	...
	t.Run("return ErrAlertRuleGroupNotFound when rule group does not exist", func(t *testing.T) {
		...
		_, err := service.GetRuleGroup(context.Background(), u, orgID, groupKey.NamespaceUID, "no-rule-group")
		require.ErrorIs(t, err, store.ErrAlertRuleGroupNotFound)
	...
	t.Run("when user cannot read all rules", func(t *testing.T) {
		t.Run("it should check AuthorizeAccessToRuleGroup and propagate error", func(t *testing.T) {
			...
			_, err := service.GetRuleGroup(context.Background(), u, orgID, groupKey.NamespaceUID, groupKey.RuleGroup)
			require.Error(t, err)
			require.Equal(t, expectedErr, err)
		...
		t.Run("should return group if AuthorizeAccessToRuleGroup passes", func(t *testing.T) {
			...
			group, err := service.GetRuleGroup(context.Background(), u, orgID, groupKey.NamespaceUID, groupKey.RuleGroup)
			require.NoError(t, err)
...
func TestGetAlertRules(t *testing.T) {
	...
	t.Run("return error when CanReadAllRules return error", func(t *testing.T) {
		...
		_, _, err := service.GetAlertRules(context.Background(), u, orgID)
	...
	t.Run("when user can read all rules", func(t *testing.T) {
		t.Run("should skip AuthorizeAccessToRuleGroup and return all rules", func(t *testing.T) {
			...
			rules, provenance, err := service.GetAlertRules(context.Background(), u, orgID)
			require.NoError(t, err)
...
func initService(t *testing.T) (*AlertRuleService, *fakes.RuleStore, *fakeProvisioningStore, *fakeRuleAccessControlService) {
	t.Helper()
